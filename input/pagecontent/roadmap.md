The MIMIC Implementation Guide is still growing in the FHIR world. The usage of MIMIC-IV-on-FHIR data will guide the future directions of this IG. The current plan for the IG breaks into three sections:
